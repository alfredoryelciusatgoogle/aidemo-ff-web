      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ResultsPageWidget(
            searchKeyword: params.getParam('searchKeyword', ParamType.String),
            uploadedImageBytes:
                params.getParam('uploadedImageBytes', ParamType.FFUploadedFile),
          ),
        ),
        FFRoute(
          name: 'CheckInConfirmed',
          path: '/checkInConfirmed',
          requireAuth: true,
          builder: (context, params) => CheckInConfirmedWidget(),
        ),
        FFRoute(
          name: 'VerifySMSCode',
          path: '/verifysms',
          builder: (context, params) => VerifySMSCodeWidget(),
        ),
        FFRoute(
          name: 'ProductDetails',
          path: '/productDetails',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/@3xlogoMark_outlinePrimary_transparent.png',
                      width: 100.0,
                      height: 100.0,
                      fit: BoxFit.cover,
                    ),
