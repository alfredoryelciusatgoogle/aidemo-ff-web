...
String? serializeParam(
  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.PostgresRow:
        return json.encode((param as PostgresDataRow).data);
  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.PostgresRow:
        ...
        switch (T) {
          case LocationMasterRow:
            return LocationMasterRow(data);
          case MovieStarsRow:
            return MovieStarsRow(data);
          case SampleTableRow:
